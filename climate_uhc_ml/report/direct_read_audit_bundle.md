...
|---|---:|---|
| bundle_rows | 180 | Rows in result/direct_read_audit_bundle.csv. |
| manifest_rows | 792 | Curated artifact rows in result/direct_read_artifact_manifest.csv. |
| manifest_present_nonempty | 788 | Curated artifacts present and non-empty. |
...
| bundle_section_priority_bundle | 71 | Direct-read bundle section count. |
