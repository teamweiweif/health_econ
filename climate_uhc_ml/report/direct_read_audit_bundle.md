...
| manifest_rows | 618 | Curated artifact rows in result/direct_read_artifact_manifest.csv. |
| manifest_present_nonempty | 614 | Curated artifacts present and non-empty. |
