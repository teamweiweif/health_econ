...
| manifest_rows | 453 | Curated artifact rows in result/direct_read_artifact_manifest.csv. |
| manifest_present_nonempty | 453 | Curated artifacts present and non-empty. |
...
| bundle_section_priority_bundle | 10 | Direct-read bundle section count. |
