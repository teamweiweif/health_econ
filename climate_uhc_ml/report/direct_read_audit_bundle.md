...
|---|---:|---|
| bundle_rows | 181 | Rows in result/direct_read_audit_bundle.csv. |
| manifest_rows | 798 | Curated artifact rows in result/direct_read_artifact_manifest.csv. |
| manifest_present_nonempty | 794 | Curated artifacts present and non-empty. |
...
| bundle_section_priority_bundle | 72 | Direct-read bundle section count. |
