...
| priority_lsms_isa_receipt_checklist_package_received_rows | 4 | Refocused LSMS/ISA waves with original package receipt evidence. |
...
| priority_lsms_isa_external_staging_executed_dataset_rows | 3 | External local raw-folder candidates copied into temp/raw_downloads for receipt validation. |
| priority_lsms_isa_external_staging_copied_file_rows | 304 | Raw/documentation files staged from external local folders. |
...
| priority_lsms_isa_country_wave_packet_failed_gates | 300 | Refocused LSMS/ISA packet gates still blocking promotion. |
...
| priority_lsms_raw_intake_original_file_rows | 305 | Non-generated original package/documentation candidates found in target folders. |
| priority_lsms_raw_intake_missing_package_rows | 15 | Refocused targets with no original package files yet. |
| priority_lsms_raw_intake_blocked_requirement_rows | 128 | Raw-package acceptance requirements still blocked. |
...
| priority_lsms_archive_preflight_direct_file_rows | 305 | Direct non-generated original files detected by archive preflight. |
| priority_lsms_archive_preflight_archive_member_rows | 52 | Readable archive member rows detected without extraction. |
| priority_lsms_archive_preflight_blocked_dataset_rows | 15 | Refocused targets still blocked before schema/manual raw review. |
| priority_lsms_archive_preflight_blocked_requirement_rows | 120 | Archive preflight requirement rows still blocked. |
