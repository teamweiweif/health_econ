...
|---|---:|---|
| bundle_rows | 179 | Rows in result/direct_read_audit_bundle.csv. |
| manifest_rows | 787 | Curated artifact rows in result/direct_read_artifact_manifest.csv. |
| manifest_present_nonempty | 783 | Curated artifacts present and non-empty. |
...
| bundle_section_priority_bundle | 70 | Direct-read bundle section count. |
