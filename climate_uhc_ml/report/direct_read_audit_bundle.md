...
| manifest_rows | 458 | Curated artifact rows in result/direct_read_artifact_manifest.csv. |
| manifest_present_nonempty | 458 | Curated artifacts present and non-empty. |
