...
| manifest_rows | 643 | Curated artifact rows in result/direct_read_artifact_manifest.csv. |
| manifest_present_nonempty | 639 | Curated artifacts present and non-empty. |
