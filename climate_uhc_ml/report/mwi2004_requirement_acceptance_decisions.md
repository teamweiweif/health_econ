...
| final_verified_requirements | 3 | Requirements accepted as final raw-value verified for their stated scope. |
...
| health_access_policy_final_verified | 0 | Whether the health/access construct is final verified; must remain zero here. |
...
The current decision remains fail-closed: `final_verified_requirements=3`
