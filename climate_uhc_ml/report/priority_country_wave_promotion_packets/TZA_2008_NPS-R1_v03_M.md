...
| official_metadata_variable_evidence_extract | pass | status=partial_official_metadata_evidence_extract; candidates=105; ddi_matches=104; file_matches=104; no_matches=1 |  |
| credentialed_raw_acquisition_ledger | pass | status=ready_for_credentialed_manual_download; full_files=61; core_files=12; target_folder=temp/raw_downloads/TZA_200... |  |
...
| manual_variable_verification | fail | variables_passed=0/105 | Manually verify selected raw variables before harmonization recipe review. |
...
|---|---|---|
| get_microdata_html | saved_existing_access_probe | temp/source_snapshots/priority_official_raw_access/7_TZA_2008_NPS-R1_v03_M/get_microdata.html |
| pdf_documentation | saved_existing | temp/source_snapshots/priority_public_documentation/7_TZA_2008_NPS-R1_v03_M/pdf_documentation.pdf |
| ddi_metadata | saved_existing | temp/source_snapshots/priority_public_documentation/7_TZA_2008_NPS-R1_v03_M/ddi_metadata.xml |
| json_metadata | saved_existing | temp/source_snapshots/priority_public_documentation/7_TZA_2008_NPS-R1_v03_M/json_metadata.json |
| data_dictionary_html | saved_existing | temp/source_snapshots/priority_public_documentation/7_TZA_2008_NPS-R1_v03_M/data_dictionary_html.html |
| related_materials_html | saved_existing | temp/source_snapshots/priority_public_documentation/7_TZA_2008_NPS-R1_v03_M/related_materials_html.html |

## Priority Raw File Queue

| file_rank | file_name | candidate_categories | candidate_harmonized_variables |
|---|---|---|---|
| 1 | SEC_3A_English_Labels | consumption;health_need_access;shocks;survey_design | agriculture_livelihood;care_not_sought_reason;coping_borrowed;hhid;reason_not_sought_distance;shock_module_variable;t... |
| 2 | SEC_3B_English_Labels | consumption;health_need_access;shocks;survey_design | agriculture_livelihood;care_not_sought_reason;coping_borrowed;hhid;reason_not_sought_distance;shock_module_variable;t... |
| 3 | SEC_B_C_D_E1_F_G1_U_English_Labels | demographics;geography;health_expenditure;health_need_access;shocks;survey_design | admin1_or_admin2;age;agriculture_livelihood;asset_index_or_asset_variable;care_sought;education;hhid;household_weight... |
| 4 | HH.Geovariables_Y1 | geography;health_need_access;shocks;survey_design | admin1_or_admin2;agriculture_livelihood;hhid;latitude_or_longitude;psu_or_cluster_id;reason_not_sought_distance;shock... |
| 5 | SEC_4A_English_Labels | shocks;survey_design | agriculture_livelihood;hhid;shock_module_variable |
| 6 | SEC_A_T_English_Labels | geography;shocks;survey_design | admin1_or_admin2;agriculture_livelihood;hhid;household_weight_or_person_weight;psu_or_cluster_id;rural;shock_module_v... |
| 7 | SEC_H1_J_K2_O2_P1_Q1_S1_English_Labels | demographics;geography;shocks;survey_design | admin1_or_admin2;age;asset_index_or_asset_variable;coping_borrowed;hhid;shock_module_variable |
| 8 | TZY1.HH.Consumption | consumption;demographics;geography;health_need_access;survey_design | admin1_or_admin2;education;hhid;household_size;household_weight_or_person_weight;interview_date_or_survey_month;psu_o... |
| 9 | SEC_S2_English_Labels | demographics;health_need_access;survey_design | age;asset_index_or_asset_variable;hhid;illness_or_injury_need;sex |
| 10 | SECTCEFG | geography;shocks;survey_design | admin1_or_admin2;agriculture_livelihood;psu_or_cluster_id;shock_module_variable |
| 11 | SEC_P2_English_Labels | shocks;survey_design | coping_borrowed;hhid |
| 12 | SECTCH | demographics;geography;shocks;survey_design | admin1_or_admin2;agriculture_livelihood;asset_index_or_asset_variable;education;psu_or_cluster_id;sex |
