...
Survey: General Household Survey, Panel  2012-2013, Wave 2

Official URL: https://microdata.worldbank.org/catalog/1952/get-microdata

Target raw folder: `temp/raw_downloads/NGA_2012_GHSP-W2_v02_M/`
...
| official_metadata_variable_evidence_extract | pass | status=partial_official_metadata_evidence_extract; candidates=79; ddi_matches=78; file_matches=78; no_matches=1 |  |
| credentialed_raw_acquisition_ledger | pass | status=ready_for_credentialed_manual_download; full_files=103; core_files=12; target_folder=temp/raw_downloads/NGA_20... |  |
...
| manual_variable_verification | fail | variables_passed=0/79 | Manually verify selected raw variables before harmonization recipe review. |
...
|---|---|---|
| get_microdata_html | saved_existing_access_probe | temp/source_snapshots/priority_official_raw_access/4_NGA_2012_GHSP-W2_v02_M/get_microdata.html |
| pdf_documentation | saved_existing | temp/source_snapshots/priority_public_documentation/4_NGA_2012_GHSP-W2_v02_M/pdf_documentation.pdf |
| ddi_metadata | saved_existing | temp/source_snapshots/priority_public_documentation/4_NGA_2012_GHSP-W2_v02_M/ddi_metadata.xml |
| json_metadata | saved_existing | temp/source_snapshots/priority_public_documentation/4_NGA_2012_GHSP-W2_v02_M/json_metadata.json |
| data_dictionary_html | saved_existing | temp/source_snapshots/priority_public_documentation/4_NGA_2012_GHSP-W2_v02_M/data_dictionary_html.html |
| related_materials_html | saved_existing | temp/source_snapshots/priority_public_documentation/4_NGA_2012_GHSP-W2_v02_M/related_materials_html.html |

## Priority Raw File Queue

| file_rank | file_name | candidate_categories | candidate_harmonized_variables |
|---|---|---|---|
| 1 | secta1_harvestw2 | geography;shocks;survey_design | admin1_or_admin2;agriculture_livelihood;hhid;latitude_or_longitude;psu_or_cluster_id |
| 2 | sect11b1_plantingw2 | geography;shocks;survey_design | admin1_or_admin2;agriculture_livelihood;hhid;pid;psu_or_cluster_id |
| 3 | sect11h_plantingw2 | geography;health_need_access;shocks;survey_design | admin1_or_admin2;agriculture_livelihood;coping_borrowed;hhid;pid;psu_or_cluster_id;reason_not_sought_distance |
| 4 | sect4a_harvestw2 | demographics;geography;health_expenditure;health_need_access;survey_design | admin1_or_admin2;age;care_sought;education;hhid;household_weight_or_person_weight;illness_or_injury_need;oop_health_e... |
| 5 | secta3_harvestw2 | geography;health_need_access;shocks;survey_design | admin1_or_admin2;agriculture_livelihood;care_not_sought_reason;hhid;psu_or_cluster_id |
| 6 | sect11d_plantingw2 | geography;health_need_access;shocks;survey_design | admin1_or_admin2;agriculture_livelihood;coping_borrowed;hhid;pid;psu_or_cluster_id;reason_not_sought_distance |
| 7 | sect9_harvestw2 | demographics;geography;health_need_access;shocks;survey_design | admin1_or_admin2;agriculture_livelihood;coping_borrowed;hhid;psu_or_cluster_id;reason_not_sought_distance;reason_not_... |
| 8 | sect11e_plantingw2 | geography;health_need_access;shocks;survey_design | admin1_or_admin2;agriculture_livelihood;coping_borrowed;hhid;psu_or_cluster_id;reason_not_sought_distance |
| 9 | secta2_harvestw2 | geography;shocks;survey_design | admin1_or_admin2;agriculture_livelihood;hhid;psu_or_cluster_id |
| 10 | sect6_plantingw2 | demographics;geography;health_need_access;shocks;survey_design | admin1_or_admin2;agriculture_livelihood;coping_borrowed;hhid;psu_or_cluster_id;reason_not_sought_distance;reason_not_... |
| 11 | NGA_HouseholdGeovars_Y2 | geography;health_need_access;shocks;survey_design | admin1_or_admin2;agriculture_livelihood;hhid;latitude_or_longitude;psu_or_cluster_id;reason_not_sought_distance;shock... |
| 12 | sect8_harvestw2 | demographics;geography;survey_design | admin1_or_admin2;asset_index_or_asset_variable;hhid;psu_or_cluster_id |
