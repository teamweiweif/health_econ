...
| official_metadata_variable_evidence_extract | pass | status=partial_official_metadata_evidence_extract; candidates=90; ddi_matches=89; file_matches=89; no_matches=1 |  |
| credentialed_raw_acquisition_ledger | pass | status=ready_for_credentialed_manual_download; full_files=104; core_files=12; target_folder=temp/raw_downloads/NGA_20... |  |
...
| manual_variable_verification | fail | variables_passed=0/90 | Manually verify selected raw variables before harmonization recipe review. |
...
|---|---|---|
| get_microdata_html | saved_existing_access_probe | temp/source_snapshots/priority_official_raw_access/5_NGA_2015_GHSP-W3_v02_M/get_microdata.html |
| pdf_documentation | saved_existing | temp/source_snapshots/priority_public_documentation/5_NGA_2015_GHSP-W3_v02_M/pdf_documentation.pdf |
| ddi_metadata | saved_existing | temp/source_snapshots/priority_public_documentation/5_NGA_2015_GHSP-W3_v02_M/ddi_metadata.xml |
| json_metadata | saved_existing | temp/source_snapshots/priority_public_documentation/5_NGA_2015_GHSP-W3_v02_M/json_metadata.json |
| data_dictionary_html | saved_existing | temp/source_snapshots/priority_public_documentation/5_NGA_2015_GHSP-W3_v02_M/data_dictionary_html.html |
| related_materials_html | saved_existing | temp/source_snapshots/priority_public_documentation/5_NGA_2015_GHSP-W3_v02_M/related_materials_html.html |

## Priority Raw File Queue

| file_rank | file_name | candidate_categories | candidate_harmonized_variables |
|---|---|---|---|
| 1 | sect11b1_plantingw3 | geography;shocks;survey_design | admin1_or_admin2;agriculture_livelihood;hhid;psu_or_cluster_id |
| 2 | secta3ii_harvestw3 | demographics;geography;shocks;survey_design | admin1_or_admin2;agriculture_livelihood;asset_index_or_asset_variable;hhid;psu_or_cluster_id |
| 3 | secta1_harvestw3 | geography;shocks;survey_design | admin1_or_admin2;agriculture_livelihood;hhid;latitude_or_longitude;psu_or_cluster_id |
| 4 | secta11d_harvestw3 | geography;health_need_access;shocks;survey_design | admin1_or_admin2;agriculture_livelihood;coping_borrowed;hhid;psu_or_cluster_id;reason_not_sought_distance |
| 5 | sect4a_harvestw3 | demographics;geography;health_expenditure;health_need_access;survey_design | admin1_or_admin2;care_sought;education;hhid;household_weight_or_person_weight;illness_or_injury_need;oop_health_expen... |
| 6 | secta2_harvestw3 | geography;shocks;survey_design | admin1_or_admin2;agriculture_livelihood;hhid;psu_or_cluster_id |
| 7 | sect11f_plantingw3 | geography;shocks;survey_design | admin1_or_admin2;agriculture_livelihood;hhid;psu_or_cluster_id |
| 8 | secta3i_harvestw3 | geography;health_need_access;shocks;survey_design | admin1_or_admin2;agriculture_livelihood;care_not_sought_reason;hhid;psu_or_cluster_id |
| 9 | sect11_plantingw3 | demographics;geography;survey_design | admin1_or_admin2;asset_index_or_asset_variable;hhid;psu_or_cluster_id |
| 10 | NGA_HouseholdGeovars_Y3 | geography;health_need_access;shocks;survey_design | admin1_or_admin2;agriculture_livelihood;hhid;latitude_or_longitude;psu_or_cluster_id;reason_not_sought_distance;shock... |
| 11 | sect11e_plantingw3 | geography;health_need_access;shocks;survey_design | admin1_or_admin2;agriculture_livelihood;coping_borrowed;hhid;psu_or_cluster_id;reason_not_sought_distance |
| 12 | sect1_harvestw3 | demographics;geography;health_need_access;survey_design | admin1_or_admin2;age;education;hhid;pid;psu_or_cluster_id;reason_not_sought_distance;sex |
