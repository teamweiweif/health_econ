...
Survey: Marriage Transitions in Malawi 2007-2009, Panel Data

Official URL: https://microdata.worldbank.org/catalog/3462/get-microdata

Target raw folder: `temp/raw_downloads/MWI_2007-2009_MTM_v01_M/`
...
| official_metadata_variable_evidence_extract | pass | status=partial_official_metadata_evidence_extract; candidates=128; ddi_matches=126; file_matches=126; no_matches=2 |  |
| official_endpoint_matrix_probe | pass | status=metadata_api_confirmed_raw_access_gate_confirmed; endpoints=8; metadata_endpoints=4; variable_api=0; get_micro... |  |
| credentialed_raw_acquisition_ledger | pass | status=ready_for_credentialed_manual_download; full_files=118; core_files=12; target_folder=temp/raw_downloads/MWI_20... |  |
...
| manual_variable_verification | fail | variables_passed=0/128 | Manually verify selected raw variables before harmonization recipe review. |
...
|---|---|---|
| get_microdata_html | saved_existing_access_probe | temp/source_snapshots/priority_official_raw_access/3_MWI_2007-2009_MTM_v01_M/get_microdata.html |
| pdf_documentation | missing_optional_url |  |
| ddi_metadata | saved_existing | temp/source_snapshots/priority_public_documentation/3_MWI_2007-2009_MTM_v01_M/ddi_metadata.xml |
| json_metadata | saved_existing | temp/source_snapshots/priority_public_documentation/3_MWI_2007-2009_MTM_v01_M/json_metadata.json |
| data_dictionary_html | saved_existing | temp/source_snapshots/priority_public_documentation/3_MWI_2007-2009_MTM_v01_M/data_dictionary_html.html |
| related_materials_html | saved_existing | temp/source_snapshots/priority_public_documentation/3_MWI_2007-2009_MTM_v01_M/related_materials_html.html |
...
| 2 | pi_s5a | demographics;health_need_access;survey_design | care_not_sought_reason;education;hhid;pid;reason_not_sought_cost;reason_not_sought_distance;sex |
| 3 | p2_s14a | demographics;health_need_access;survey_design | age;education;hhid;pid;psu_or_cluster_id;reason_not_sought_cost;reason_not_sought_distance;sex |
| 4 | p2_s13 | demographics;geography;health_need_access;survey_design | admin1_or_admin2;age;asset_index_or_asset_variable;education;hhid;pid;psu_or_cluster_id;reason_not_sought_cost;sex |
| 5 | p2_s10 | demographics;health_expenditure;health_need_access;shocks;survey_design | age;agriculture_livelihood;asset_index_or_asset_variable;coping_borrowed;education;hhid;illness_or_injury_need;oop_he... |
| 6 | p2_s11 | demographics;health_expenditure;health_need_access;shocks;survey_design | age;asset_index_or_asset_variable;hhid;illness_or_injury_need;oop_health_expenditure;pid;psu_or_cluster_id;sex;shock_... |
| 7 | hh2p3_s17 | demographics;health_expenditure;health_need_access;shocks;survey_design | age;asset_index_or_asset_variable;hhid;illness_or_injury_need;oop_health_expenditure;pid;shock_module_variable |
| 8 | hh3p3_s15 | demographics;geography;health_need_access;shocks;survey_design | admin1_or_admin2;age;agriculture_livelihood;coping_borrowed;education;hhid;pid;psu_or_cluster_id;reason_not_sought_di... |
| 9 | p2_s9 | demographics;geography;survey_design | admin1_or_admin2;age;education;hhid;pid;psu_or_cluster_id;sex |
| 10 | hh2p2_s10 | demographics;geography;health_need_access;shocks;survey_design | admin1_or_admin2;age;agriculture_livelihood;asset_index_or_asset_variable;coping_borrowed;hhid;illness_or_injury_need... |
| 11 | hh2p2_s12 | demographics;geography;shocks;survey_design | admin1_or_admin2;age;agriculture_livelihood;asset_index_or_asset_variable;education;hhid;pid;psu_or_cluster_id;sex |
| 12 | hh2p3_s15 | demographics;geography;survey_design | admin1_or_admin2;age;education;hhid;pid;psu_or_cluster_id;sex |
