...
| priority_lsms_minimum_endpoint_public_metadata_endpoint_rows | 42 | Dataset-level count of successful public metadata endpoint hits. |
...
| priority_lsms_minimum_endpoint_get_microdata_gate_dataset_rows | 9 | Minimum-batch datasets whose official get-microdata endpoint shows an access gate. |
...
| priority_lsms_minimum_endpoint_credentialed_download_required_rows | 9 | Minimum-batch datasets requiring credentialed download after endpoint refresh. |
...
| priority_lsms_minimum_endpoint_classification_empty_download_route_not_raw_package | 10 | Endpoint classification count. |
| priority_lsms_minimum_endpoint_classification_http_error_not_public_endpoint | 11 | Endpoint classification count. |
| priority_lsms_minimum_endpoint_classification_idno_route_returns_catalog_or_search_html_not_raw_package | 10 | Endpoint classification count. |
| priority_lsms_minimum_endpoint_classification_official_get_microdata_access_gate | 9 | Endpoint classification count. |
| priority_lsms_minimum_endpoint_classification_public_metadata_endpoint_not_raw_package | 42 | Endpoint classification count. |
| priority_lsms_minimum_endpoint_classification_request_failed | 6 | Endpoint classification count. |
...
|---|---|---|---|---|---|---|---|---|---|
| 1 | Ethiopia | 2021-2022 | ETH_2021_ESPS-W5_v02_M | 8 | 3 | 0 | 0 | 0 | manual_endpoint_review_required |
| 2 | Ethiopia | 2018-2019 | ETH_2018_ESS_v04_M | 8 | 3 | 1 | 0 | 1 | metadata_confirmed_raw_access_gate_confirmed |
...
| 6 | Nigeria | 2010-2011 | NGA_2010_GHSP-W1_v03_M | 8 | 4 | 0 | 0 | 0 | manual_endpoint_review_required |
...
| 1 | ETH_2021_ESPS-W5_v02_M | catalog_idno_api |  | request_failed | 0 | 0 |
...
| 1 | ETH_2021_ESPS-W5_v02_M | numeric_get_microdata_page |  | request_failed | 0 | 0 |
| 1 | ETH_2021_ESPS-W5_v02_M | numeric_download_page | 200 | empty_download_route_not_raw_package | 0 | 0 |
| 1 | ETH_2021_ESPS-W5_v02_M | idno_get_microdata_page |  | request_failed | 0 | 0 |
| 2 | ETH_2018_ESS_v04_M | catalog_numeric_api | 400 | http_error_not_public_endpoint | 0 | 0 |
| 2 | ETH_2018_ESS_v04_M | catalog_idno_api |  | request_failed | 0 | 0 |
