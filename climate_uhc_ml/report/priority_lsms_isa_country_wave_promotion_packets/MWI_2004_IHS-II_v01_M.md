...
| complete_original_raw_package | fail | intake_status=blocked_missing_documentation; original_files=1; archives=1; raw_tabular=0; documentation=0 | Download/place the complete unchanged official raw package and all documentation in the target folder. |
| archive_or_direct_file_preflight | fail | status=blocked_no_documentation_candidate; direct_raw=0; direct_docs=0; archive_members=52 | Confirm readable archive/direct raw and documentation files before schema inspection. |
