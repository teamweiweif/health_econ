...
| raw_value_verification_health_need_and_access | fail | metadata=official_metadata_strong_candidates_present_raw_review_required; candidates=12; files=2; raw_status=not_raw_... | Resolve d07a skip leakage as a separate issue from person-key exceptions, classify remaining manual-review care-actio... |
...
| health_need_and_access | blocked_health_access_label_skip_or_manual_review_required | not_final_verified | Health/access label-skip artifact status=label_skip_mapping_has_skip_or_manual_review_blockers; exception_status=poli... |
