...
| raw_value_verification_household_person_keys | fail | metadata=official_metadata_strong_candidates_present_raw_review_required; candidates=12; files=12; raw_status=not_raw... | Inspect questionnaire/roster rules and decide whether unmatched health rows are valid exclusions; do not export raw IDs. |
...
| raw_value_verification_health_need_and_access | fail | metadata=official_metadata_strong_candidates_present_raw_review_required; candidates=12; files=2; raw_status=not_raw_... | Resolve d07a skip leakage rows, classify remaining manual-review care-action labels, and set double-count/formal-care... |
...
|---|---|---|---|
| household_person_keys | blocked_person_join_exception_review_required | not_final_verified | Resolve or document the 6 health-module person keys unmatched to the individual roster before full double-failure per... |
...
| health_need_and_access | blocked_health_access_label_skip_or_manual_review_required | not_final_verified | Health/access label-skip artifact status=label_skip_mapping_has_skip_or_manual_review_blockers; manual_review_rows=88... |
