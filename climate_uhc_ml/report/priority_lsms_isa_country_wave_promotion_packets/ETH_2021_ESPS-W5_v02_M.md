...
Survey: Socio-Economic Panel Survey 2021-2022

Official get-microdata URL: https://microdata.worldbank.org/catalog/6161/get-microdata

Target raw folder: `temp/raw_downloads/ETH_2021_ESPS-W5_v02_M/`
...
| official_variable_evidence_coverage | pass | coverage_rows=8; matrix_rows=84; shortlist_rows=36; no_candidate_rows=0 |  |
...
| raw_value_verification_consumption_or_income | fail | metadata=official_metadata_strong_candidates_present_raw_review_required; candidates=12; files=1; raw_status=not_raw_... | Verify this requirement against raw files, value labels, units, recall periods, skip patterns, and merge level. |
...
| raw_value_verification_survey_timing | fail | metadata=official_metadata_strong_candidates_present_raw_review_required; candidates=12; files=10; raw_status=not_raw... | Verify this requirement against raw files, value labels, units, recall periods, skip patterns, and merge level. |
...
| health_need_and_access | official_metadata_strong_candidates_present_raw_review_required | 12 | 9 | not_raw_value_verified |
...
|---|---|---|
| get_microdata_html | saved_existing | temp/source_snapshots/priority_lsms_isa_public_documentation/1_ETH_2021_ESPS-W5_v02_M/get_microdata_html.html |
| catalog_idno_json | saved_existing | temp/source_snapshots/priority_lsms_isa_public_documentation/1_ETH_2021_ESPS-W5_v02_M/catalog_idno_json.json |
| variables_idno_json | saved_existing | temp/source_snapshots/priority_lsms_isa_public_documentation/1_ETH_2021_ESPS-W5_v02_M/variables_idno_json.json |
| ddi_metadata | saved_existing | temp/source_snapshots/priority_lsms_isa_public_documentation/1_ETH_2021_ESPS-W5_v02_M/ddi_metadata.xml |
| json_metadata | saved_existing | temp/source_snapshots/priority_lsms_isa_public_documentation/1_ETH_2021_ESPS-W5_v02_M/json_metadata.json |
| data_dictionary_html | saved_existing | temp/source_snapshots/priority_lsms_isa_public_documentation/1_ETH_2021_ESPS-W5_v02_M/data_dictionary_html.html |
| related_materials_html | saved_existing | temp/source_snapshots/priority_lsms_isa_public_documentation/1_ETH_2021_ESPS-W5_v02_M/related_materials_html.html |
...
| consumption_or_income | cons_agg_w5.dta | 12 | nonfood_cons2;nom_nonfoodcons_aeq;nonfood_cons_ann;food_cons2;food_cons_ann;nom_foodcons_aeq;fafh_cons_ann;spat_totco... |
...
|---|---|---|---|---|
| household_person_keys | individual_id | Household member ID | sect1_hh_w5.dta | 37 |
| household_person_keys | household_id | Unique Household Indentifier | sect1_hh_w5.dta | 33 |
| household_person_keys | household_id | Unique Household Indentifier | sect12b1_hh_w5.dta | 33 |
| household_person_keys | household_id | Unique Household Indentifier | sect1_pp_w5.dta | 33 |
| household_person_keys | household_id | Unique Household Indentifier | sect1_ph_w5.dta | 33 |
| household_person_keys | household_id | Unique Household Indentifier | sect2_pp_w5.dta | 31 |
| household_person_keys | household_id | Unique Household Indentifier | sect3_pp_w5.dta | 31 |
| household_person_keys | household_id | Unique Household Indentifier | sect4_pp_w5.dta | 31 |
| household_person_keys | individual_id | Household member ID | sect6c_hh_w5.dta | 28 |
| household_person_keys | individual_id | Household member ID | sect2_hh_w5.dta | 28 |
| household_person_keys | individual_id | Household member ID | sect3_hh_w5.dta | 28 |
| household_person_keys | individual_id | Household member ID | sect3b_hh_w5.dta | 28 |
| weights_and_design | pw_w5 | household sample weight | sect_cover_hh_w5.dta | 33 |
| weights_and_design | ea_id | Unique Enumeration Area Indentifier | sect_cover_hh_w5.dta | 31 |
| weights_and_design | pw_w5 | household sample weight | sect6b2_hh_w5.dta | 31 |
| weights_and_design | pw_w5 | household sample weight | sect6b3_hh_w5.dta | 31 |
