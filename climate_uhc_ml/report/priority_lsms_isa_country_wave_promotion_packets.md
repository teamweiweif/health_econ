...
| 3 | core_replacement_primary | MWI_2004_IHS-II_v01_M | Malawi | 2004-2005 | ready_metadata_only | ready_metadata_only_raw_review_required | raw_payload_present_documentation_missing | blocked_no_documentation_candidate | blocked_not_raw_value_verified | blocked | blocked_fail_closed | download_or_place_complete_original_raw_package |
...
| 3 | MWI_2004_IHS-II_v01_M | complete_original_raw_package | fail | intake_status=blocked_missing_documentation; original_files=1; archives=1; raw_tabular=0; documentation=0 | Download/place the complete unchanged official raw package and all documentation in the target folder. |
| 3 | MWI_2004_IHS-II_v01_M | archive_or_direct_file_preflight | fail | status=blocked_no_documentation_candidate; direct_raw=0; direct_docs=0; archive_members=52 | Confirm readable archive/direct raw and documentation files before schema inspection. |
