...
| priority_lsms_country_wave_packet_passed_gate_rows | 73 | Packet gates currently passing. |
| priority_lsms_country_wave_packet_failed_gate_rows | 288 | Packet gates still blocking promotion. |
...
| priority_lsms_country_wave_packet_raw_package_ready_rows | 10 | Packets with complete original raw package receipt and documentation. |
| priority_lsms_country_wave_packet_archive_preflight_ready_rows | 10 | Packets with readable archive/direct raw preflight. |
...
| priority_lsms_country_wave_packet_analysis_synthesis_ready_rows | 1 | Packets ready for promoted dataset synthesis. |
| priority_lsms_country_wave_packet_analysis_ready_rows | 1 | Packets ready for promoted data writes. |
| priority_lsms_country_wave_packet_action_rows | 18 | Next blocking actions across LSMS/ISA packets. |
...
| priority_lsms_country_wave_packet_data_write_status | open_registry_has_promoted_rows | Whether any LSMS/ISA country-wave may write to data/ from promoted packet evidence. |
...
| priority_lsms_country_wave_packet_next_action_complete_raw_value_key_unit_verification | 9 | Next blocking action count. |
| priority_lsms_country_wave_packet_next_action_download_or_place_complete_original_raw_package | 9 | Next blocking action count. |
...
| 6 | core_selected_lsms_isa_aligned | NGA_2010_GHSP-W1_v03_M | Nigeria | 2010-2011 | ready_metadata_only | ready_metadata_only_raw_review_required | raw_archive_plus_official_public_documentation_ready_for_raw_review | ready_for_raw_receipt_schema_and_manual_review | blocked_not_raw_value_verified | blocked | blocked_fail_closed | complete_raw_value_key_unit_verification |
| 7 | core_selected_lsms_isa_aligned | TZA_2008_NPS-R1_v03_M | Tanzania | 2008-2009 | ready_metadata_only | ready_metadata_only_raw_review_required | raw_archive_plus_official_public_documentation_ready_for_raw_review | ready_for_raw_receipt_schema_and_manual_review | blocked_not_raw_value_verified | blocked | blocked_fail_closed | complete_raw_value_key_unit_verification |
...
| 16 | replacement_backup_wave | MWI_2010_IHS-III_v01_M | Malawi | 2010-2011 | ready_metadata_only | ready_metadata_only_raw_review_required | raw_archive_plus_official_public_documentation_ready_for_raw_review | ready_for_raw_receipt_schema_and_manual_review | blocked_not_raw_value_verified | blocked | blocked_fail_closed | complete_raw_value_key_unit_verification |
| 17 | replacement_backup_wave | UGA_2011_UNPS_v02_M | Uganda | 2011-2012 | ready_metadata_only | ready_metadata_only_raw_review_required | raw_archive_plus_official_public_documentation_ready_for_raw_review | ready_for_raw_receipt_schema_and_manual_review | blocked_not_raw_value_verified | blocked | blocked_fail_closed | complete_raw_value_key_unit_verification |
...
| 3 | NGA_2012_GHSP-W2_v02_M | complete_raw_value_key_unit_verification | Verify merge keys, weights/design, consumption/income, OOP, access, timing, geography, missing codes, units, recall p... | temp/raw_downloads/NGA_2012_GHSP-W2_v02_M/ |
...
| 5 | NGA_2010_GHSP-W1_v03_M | complete_raw_value_key_unit_verification | Verify merge keys, weights/design, consumption/income, OOP, access, timing, geography, missing codes, units, recall p... | temp/raw_downloads/NGA_2010_GHSP-W1_v03_M/ |
| 6 | TZA_2008_NPS-R1_v03_M | complete_raw_value_key_unit_verification | Verify merge keys, weights/design, consumption/income, OOP, access, timing, geography, missing codes, units, recall p... | temp/raw_downloads/TZA_2008_NPS-R1_v03_M/ |
...
| 12 | NPL_2010_LSS-III_v01_M | download_or_place_complete_original_raw_package | Download/place the complete unchanged official raw package and all documentation in local_target_folder. | temp/raw_downloads/NPL_2010_LSS-III_v01_M/ |
| 13 | MWI_2019_IHS-V_v06_M | download_or_place_complete_original_raw_package | Download/place the complete unchanged official raw package and all documentation in local_target_folder. | temp/raw_downloads/MWI_2019_IHS-V_v06_M/ |
| 14 | MWI_2016_IHS-IV_v04_M | complete_raw_value_key_unit_verification | Verify merge keys, weights/design, consumption/income, OOP, access, timing, geography, missing codes, units, recall p... | temp/raw_downloads/MWI_2016_IHS-IV_v04_M/ |
| 15 | MWI_2010_IHS-III_v01_M | complete_raw_value_key_unit_verification | Verify merge keys, weights/design, consumption/income, OOP, access, timing, geography, missing codes, units, recall p... | temp/raw_downloads/MWI_2010_IHS-III_v01_M/ |
| 16 | UGA_2011_UNPS_v02_M | complete_raw_value_key_unit_verification | Verify merge keys, weights/design, consumption/income, OOP, access, timing, geography, missing codes, units, recall p... | temp/raw_downloads/UGA_2011_UNPS_v02_M/ |
| 17 | UGA_2018_UNPS_v02_M | download_or_place_complete_original_raw_package | Download/place the complete unchanged official raw package and all documentation in local_target_folder. | temp/raw_downloads/UGA_2018_UNPS_v02_M/ |
| 18 | UGA_2015_UNPS_v02_M | download_or_place_complete_original_raw_package | Download/place the complete unchanged official raw package and all documentation in local_target_folder. | temp/raw_downloads/UGA_2015_UNPS_v02_M/ |
...
| 4 | NGA_2012_GHSP-W2_v02_M | raw_value_verification_consumption_or_income | fail | metadata=official_metadata_strong_candidates_present_raw_review_required; candidates=12; files=4; raw_status=not_raw_... | Verify this requirement against raw files, value labels, units, recall periods, skip patterns, and merge level. |
| 4 | NGA_2012_GHSP-W2_v02_M | raw_value_verification_oop_health_expenditure | fail | metadata=official_metadata_strong_candidates_present_raw_review_required; candidates=6; files=1; raw_status=not_raw_v... | Verify this requirement against raw files, value labels, units, recall periods, skip patterns, and merge level. |
| 4 | NGA_2012_GHSP-W2_v02_M | raw_value_verification_health_need_and_access | fail | metadata=official_metadata_strong_candidates_present_raw_review_required; candidates=12; files=3; raw_status=not_raw_... | Verify this requirement against raw files, value labels, units, recall periods, skip patterns, and merge level. |
| 4 | NGA_2012_GHSP-W2_v02_M | raw_value_verification_survey_timing | fail | metadata=official_metadata_strong_candidates_present_raw_review_required; candidates=12; files=1; raw_status=not_raw_... | Verify this requirement against raw files, value labels, units, recall periods, skip patterns, and merge level. |
