# Country-Wave Promotion Packet: Bulgaria 1995

Dataset: `Integrated Household Survey 1995`

IDNO: `BGR_1995_IHS_v01_M`

Official URL: https://microdata.worldbank.org/catalog/2271/get-microdata

Local target folder: `temp/raw_downloads/BGR_1995_IHS_v01_M/`
...
| raw_value_unit_recall_missing_verification | fail | raw_not_inspected=63 | Inspect raw labels/values, merge keys, units, recall periods, skip patterns, and missing codes. |
...
- `HHCOMP`: not_present; concepts=hhid;sex
...
- `FILE01V0`: not_present; concepts=admin1_or_admin2;hhid;interview_date_or_survey_month;psu_or_cluster_id;sex
...
- `SAMPLE01;STRATA` / `province`: climate_geography; raw_not_inspected; action=inspect raw values, labels, merge keys, units, recall period, and missing codes before harmonization
- `ADJUSTR;FILE01V0;HHINCTL;STRATA` / `distr`: climate_geography; raw_not_inspected; action=inspect raw values, labels, merge keys, units, recall period, and missing codes before harmonization
...
- `FILE01V0;FILE02V1;FILE36V1;INDINCTL` / `gender`: demographics; raw_not_inspected; action=inspect raw values, labels, merge keys, units, recall period, and missing codes before harmonization
