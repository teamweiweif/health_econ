# Priority Climate Linkage Handoff: ETH_2018_ESS_v04_M

This is a fail-closed climate-linkage preflight for `Ethiopia`
`2018-2019`. It does not extract climate data and does not accept a
...
Candidate timing files: sect_cover_hh_w4.dta;sect_cover_ls_w4.dta;sect_cover_ph_w4.dta;sect_cover_pp_w4.dta

Candidate geography files: ETH_HouseholdGeovariables_Y4.dta;ET_local_area_unit_conversion.dta;cons_agg_w4.dta;sect01a_com_w4.dta;sect01b_com_w4.dta;sect02_com_w4.dta;sect03_com_w4.dta;sect04_com_w4.dta;sect05_com_w4.dta;sect06_com_w4.dta
