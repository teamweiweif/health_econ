# Priority Climate Linkage Handoff: TZA_2008_NPS-R1_v03_M

This is a fail-closed climate-linkage preflight for `Tanzania`
`2008-2009`. It does not extract climate data and does not accept a
...
Candidate timing files: SECTA1A2_English_Labels;TZY1.HH.Consumption

Candidate geography files: HH.Geovariables_Y1;SECTA1A2_English_Labels;SECTA1A2_Swahili_Labels;SECTCB;SECTCB_Swahili_Labels;SECTCC;SECTCD;SECTCEFG;SECTCH;SECTCI
