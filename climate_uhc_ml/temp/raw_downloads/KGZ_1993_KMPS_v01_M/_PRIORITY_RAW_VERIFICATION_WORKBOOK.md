# Priority Raw Verification Workbook: KGZ_1993_KMPS_v01_M

This workbook is the post-download verification gate for `Kyrgyz Republic`
`1993`. It does not verify the dataset by itself; all blank
