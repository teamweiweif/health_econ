# Priority Climate Linkage Handoff: KGZ_1993_KMPS_v01_M

This is a fail-closed climate-linkage preflight for `Kyrgyz Republic`
`1993`. It does not extract climate data and does not accept a
...
Candidate timing files: CORE;KADULT;KCHILD;KHHLD

Candidate geography files: CORE;KCOMM
