# Priority Climate Linkage Handoff: TZA_2010_NPS-R2_v03_M

This is a fail-closed climate-linkage preflight for `Tanzania`
`2010-2011`. It does not extract climate data and does not accept a
...
Candidate timing files: TZY1.HH.Consumption;TZY2.HH.Consumption

Candidate geography files: AG_SEC2A;AG_SEC2B;COMSEC_CA;COMSEC_CB;COMSEC_CD;COMSEC_CE;COMSEC_CF;COMSEC_CG;COMSEC_CH;COMSEC_CI
