# Priority Climate Linkage Handoff: JAM_1997_SLC_v01_M

This is a fail-closed climate-linkage preflight for `Jamaica`
`1997`. It does not extract climate data and does not accept a
...
Candidate timing files: REC001

Candidate geography files: ANNUAL;EDTOTALS;HEADS;HHSIZE;REC001;EXP97;LABORF
