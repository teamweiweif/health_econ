# Priority Raw Verification Workbook: JAM_1997_SLC_v01_M

This workbook is the post-download verification gate for `Jamaica`
`1997`. It does not verify the dataset by itself; all blank
