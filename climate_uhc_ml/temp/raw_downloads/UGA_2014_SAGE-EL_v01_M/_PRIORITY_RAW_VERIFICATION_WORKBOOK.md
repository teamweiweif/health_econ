# Priority Raw Verification Workbook: UGA_2014_SAGE-EL_v01_M

This workbook is the post-download verification gate for `Uganda`
`2014`. It does not verify the dataset by itself; all blank
