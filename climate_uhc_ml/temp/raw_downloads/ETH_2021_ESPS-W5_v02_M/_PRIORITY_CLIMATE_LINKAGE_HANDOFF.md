# Priority Climate Linkage Handoff: ETH_2021_ESPS-W5_v02_M

This is a fail-closed climate-linkage preflight for `Ethiopia`
`2021-2022`. It does not extract climate data and does not accept a
...
Candidate timing files: sect_cover_ls_w5.dta;sect_cover_ph_w5.dta;sect_cover_pp_w5.dta

Candidate geography files: cons_agg_w5.dta;eth_householdgeovariables_y5.dta;eth_plotgeovariables_y5.dta;sect01a_com_w5.dta;sect01b_com_w5.dta;sect02_com_w5.dta;sect03_com_w5.dta;sect04_com_w5.dta;sect05_com_w5.dta;sect06_com_w5.dta
