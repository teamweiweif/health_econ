# Priority Raw Verification Workbook: ETH_2021_ESPS-W5_v02_M

This workbook is the post-download verification gate for `Ethiopia`
`2021-2022`. It does not verify the dataset by itself; all blank
