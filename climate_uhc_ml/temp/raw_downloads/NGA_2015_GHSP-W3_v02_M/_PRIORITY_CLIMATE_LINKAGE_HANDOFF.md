# Priority Climate Linkage Handoff: NGA_2015_GHSP-W3_v02_M

This is a fail-closed climate-linkage preflight for `Nigeria`
`2015-2016`. It does not extract climate data and does not accept a
...
Candidate timing files: sectc_harvestw3;sectc_plantingw3

Candidate geography files: NGA_HouseholdGeovars_Y3;sect11a1_plantingw3;secta1_harvestw3
