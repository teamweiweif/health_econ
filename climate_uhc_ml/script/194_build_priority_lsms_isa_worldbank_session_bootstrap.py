        ...
        rows.append(
            {
                ...
                "probe_command": f"python script/180_build_priority_lsms_isa_credentialed_download_handoff.py --idno {idno} --probe",
                "execute_command": f"python script/180_build_priority_lsms_isa_credentialed_download_handoff.py --idno {idno} --execute",
