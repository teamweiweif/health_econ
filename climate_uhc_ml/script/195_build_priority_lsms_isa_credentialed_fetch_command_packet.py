        ...
        rows.append(
            {
                ...
                "python_probe_command": f"python script/180_build_priority_lsms_isa_credentialed_download_handoff.py --idno {idno} --probe",
                "python_execute_command": f"python script/180_build_priority_lsms_isa_credentialed_download_handoff.py --idno {idno} --execute",
