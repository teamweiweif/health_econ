...
CURATED_ARTIFACTS = [
    ...
    ("dataset_promotion", "report/mwi2004_sdg382_spl_bridge_verification_gate.md", "Malawi 2004 SDG 3.8.2 SPL bridge verification gate report"),
    ("dataset_promotion", "result/mwi2004_sdg382_spl_bridge_verification_gate.csv", "Malawi 2004 SDG 3.8.2 SPL bridge verification gate"),
    ("dataset_promotion", "result/mwi2004_sdg382_spl_bridge_verification_gate_summary.csv", "Malawi 2004 SDG 3.8.2 SPL bridge verification summary"),
    ...
    ("dataset_promotion", "report/priority_lsms_isa_post_download_receipt_handoff.md", "priority LSMS/ISA post-download receipt handoff report"),
    ...
    ("dataset_promotion", "report/priority_lsms_isa_acquisition_gap_receipt_board.md", "priority LSMS/ISA acquisition gap receipt board report"),
    ("dataset_promotion", "result/priority_lsms_isa_acquisition_gap_receipt_board.csv", "priority LSMS/ISA acquisition gap receipt board"),
    ("dataset_promotion", "result/priority_lsms_isa_acquisition_gap_receipt_summary.csv", "priority LSMS/ISA acquisition gap receipt summary"),
    ("dataset_promotion", "report/priority_lsms_isa_external_local_raw_candidate_audit.md", "priority LSMS/ISA external local raw candidate audit report"),
    ("dataset_promotion", "result/priority_lsms_isa_external_local_raw_candidate_audit.csv", "priority LSMS/ISA external local raw candidate audit"),
    ("dataset_promotion", "result/priority_lsms_isa_external_local_raw_candidate_file_match.csv", "priority LSMS/ISA external local raw candidate file-name match audit"),
    ("dataset_promotion", "result/priority_lsms_isa_external_local_raw_candidate_summary.csv", "priority LSMS/ISA external local raw candidate summary"),
    ("dataset_promotion", "report/priority_lsms_isa_external_local_raw_intake_decision.md", "priority LSMS/ISA external local raw intake decision report"),
    ("dataset_promotion", "result/priority_lsms_isa_external_local_raw_intake_decision.csv", "priority LSMS/ISA external local raw intake decision queue"),
    ("dataset_promotion", "result/priority_lsms_isa_external_local_raw_document_manifest.csv", "priority LSMS/ISA external local raw documentation manifest"),
    ("dataset_promotion", "result/priority_lsms_isa_external_local_raw_intake_summary.csv", "priority LSMS/ISA external local raw intake summary"),
    ("dataset_promotion", "report/priority_lsms_isa_external_local_raw_staging.md", "priority LSMS/ISA external local raw staging report"),
    ("dataset_promotion", "temp/priority_lsms_isa_external_local_raw_staging_plan.csv", "priority LSMS/ISA external local raw staging plan"),
    ("dataset_promotion", "temp/priority_lsms_isa_external_local_raw_staging_file_manifest.csv", "priority LSMS/ISA external local raw staging file manifest"),
    ("dataset_promotion", "result/priority_lsms_isa_external_local_raw_staging_summary.csv", "priority LSMS/ISA external local raw staging summary"),
    ...
    ("reproducibility", "script/207_build_mwi2004_sdg382_spl_bridge_verification_gate.py", "Malawi 2004 SDG 3.8.2 SPL bridge verification gate generator"),
    ...
    ("reproducibility", "script/208_build_priority_lsms_isa_acquisition_gap_receipt_board.py", "priority LSMS/ISA acquisition gap receipt board generator"),
    ("reproducibility", "script/209_build_priority_lsms_isa_external_local_raw_candidate_audit.py", "priority LSMS/ISA external local raw candidate audit generator"),
    ("reproducibility", "script/210_build_priority_lsms_isa_external_local_raw_intake_decision.py", "priority LSMS/ISA external local raw intake decision generator"),
    ("reproducibility", "script/211_stage_priority_lsms_isa_external_local_raw_packages.py", "priority LSMS/ISA external local raw staging plan and optional executor"),
...
def build_bundle(manifest: list[dict[str, str]]) -> list[dict[str, str]]:
    ...
    priority_lsms_acquisition_gap_summary = read_csv_dicts(RESULT_DIR / "priority_lsms_isa_acquisition_gap_receipt_summary.csv")
    priority_lsms_external_candidate_summary = read_csv_dicts(RESULT_DIR / "priority_lsms_isa_external_local_raw_candidate_summary.csv")
    ...
    add_bundle(
        ...
        "Focused raw value decision packet crosswalks received raw value profiles against local PDF documentation for Nigeria 2015, Tanzania 2010, and Tanzania 2012, but leaves every requirement blocked until reviewer acceptance.",
    )
    add_bundle(
        rows,
        "priority_bundle",
        ...
        "Household join readiness audit confirms that received Nigeria 2015, Tanzania 2010, and Tanzania 2012 raw packages have household-level join paths across consumption/OOP/access/timing/geography modules, while raw-value acceptance, climate linkage, data writes, and modeling remain blocked.",
    )
    add_bundle(
        rows,
        "priority_bundle",
    ...
    add_bundle(
        rows,
        "priority_bundle",
        "mwi2004_sdg382_spl_bridge_verification_gate",
        "mwi2004_sdg382_ppp_cpi_revalidated_spl_bridge_blocked"
        if csv_value(mwi2004_sdg382_spl_bridge_summary, "source_parameters_revalidated", "0") == "1"
        and csv_value(mwi2004_sdg382_spl_bridge_summary, "annual_cpi_bridge_base_period_accepted", "1") == "0"
        and csv_value(mwi2004_sdg382_spl_bridge_summary, "sdg382_ready", "1") == "0"
        else "mwi2004_sdg382_spl_bridge_verification_missing_or_overopened",
        f"country_wave={csv_value(mwi2004_sdg382_spl_bridge_summary, 'country_wave', 'missing')}; metadata_update={csv_value(mwi2004_sdg382_spl_bridge_summary, 'official_metadata_last_update', 'missing')}; world_bank_api_date={csv_value(mwi2004_sdg382_spl_bridge_summary, 'world_bank_api_revalidation_date', 'missing')}; ppp_match={csv_value(mwi2004_sdg382_spl_bridge_summary, 'wdi_ppp_private_consumption_2017_api_match', '0')}; cpi_2004_match={csv_value(mwi2004_sdg382_spl_bridge_summary, 'wdi_cpi_2004_api_match', '0')}; cpi_2017_match={csv_value(mwi2004_sdg382_spl_bridge_summary, 'wdi_cpi_2017_api_match', '0')}; candidate_spl_raw={csv_value(mwi2004_sdg382_spl_bridge_summary, 'candidate_spl_daily_raw_2004_mwk', 'missing')}; survey_povline={csv_value(mwi2004_sdg382_spl_bridge_summary, 'survey_povline_daily_raw_2004_mwk', 'missing')}; annual_bridge_accepted={csv_value(mwi2004_sdg382_spl_bridge_summary, 'annual_cpi_bridge_base_period_accepted', 'missing')}; local_spl_accepted={csv_value(mwi2004_sdg382_spl_bridge_summary, 'local_currency_spl_accepted', 'missing')}; registry_status={csv_value(mwi2004_sdg382_spl_bridge_summary, 'registry_sdg382_status', 'missing')}; data_write={csv_value(mwi2004_sdg382_spl_bridge_summary, 'data_write_gate_status', 'missing')}; modeling_gate={csv_value(mwi2004_sdg382_spl_bridge_summary, 'modeling_gate_status', 'missing')}",
        [RESULT_DIR / "mwi2004_sdg382_spl_bridge_verification_gate.csv", RESULT_DIR / "mwi2004_sdg382_spl_bridge_verification_gate_summary.csv", REPORT_DIR / "mwi2004_sdg382_spl_bridge_verification_gate.md"],
        "Malawi 2004 SPL bridge verification revalidates World Bank PPP/CPI source values against the official API while keeping SDG 3.8.2 blocked because annual CPI is not accepted as the bridge to the survey's February/March 2004 real-currency base.",
    )
    add_bundle(
        rows,
        "priority_bundle",
    ...
    add_bundle(
        rows,
        "priority_bundle",
        "priority_lsms_isa_post_download_receipt_handoff",
        "blocked_no_target_files"
        if csv_value(priority_lsms_receipt_handoff_summary, "post_download_receipt_handoff_rows", "0") == "10"
        and csv_value(priority_lsms_receipt_handoff_summary, "post_download_receipt_blocked_no_target_files_rows", "0") == "10"
        and csv_value(priority_lsms_receipt_handoff_summary, "modeling_gate_status", "missing") == "blocked"
        else "post_download_receipt_handoff_needs_review",
        f"rows={csv_value(priority_lsms_receipt_handoff_summary, 'post_download_receipt_handoff_rows', '0')}; countries={csv_value(priority_lsms_receipt_handoff_summary, 'post_download_receipt_country_rows', '0')}; expected_files={csv_value(priority_lsms_receipt_handoff_summary, 'post_download_receipt_expected_file_rows', '0')}; missing_expected={csv_value(priority_lsms_receipt_handoff_summary, 'post_download_receipt_missing_expected_file_rows', '0')}; requirement_gates={csv_value(priority_lsms_receipt_handoff_summary, 'post_download_receipt_requirement_gate_rows', '0')}; blocked_requirements={csv_value(priority_lsms_receipt_handoff_summary, 'post_download_receipt_blocked_requirement_rows', '0')}; expected_core_files={csv_value(priority_lsms_receipt_handoff_summary, 'post_download_receipt_expected_core_file_rows', '0')}; missing_core_files={csv_value(priority_lsms_receipt_handoff_summary, 'post_download_receipt_missing_core_file_rows', '0')}; target_files={csv_value(priority_lsms_receipt_handoff_summary, 'post_download_receipt_target_file_rows', '0')}; blocked_no_target={csv_value(priority_lsms_receipt_handoff_summary, 'post_download_receipt_blocked_no_target_files_rows', '0')}; modeling_gate={csv_value(priority_lsms_receipt_handoff_summary, 'modeling_gate_status', 'missing')}",
        [RESULT_DIR / "priority_lsms_isa_post_download_receipt_handoff.csv", RESULT_DIR / "priority_lsms_isa_post_download_receipt_requirement_gate.csv", RESULT_DIR / "priority_lsms_isa_post_download_receipt_handoff_summary.csv", REPORT_DIR / "priority_lsms_isa_post_download_receipt_handoff.md"],
        "Post-download receipt handoff exports target-folder, expected-file, requirement-gate, and validation-command conditions that must pass before promotion resumes.",
    )
    add_bundle(
        rows,
        "priority_bundle",
    ...
    add_bundle(
        rows,
        "priority_bundle",
        "priority_lsms_isa_acquisition_gap_receipt_board",
        "acquisition_gap_board_10_packages_threshold_gap_locked"
        if csv_value(priority_lsms_acquisition_gap_summary, "acquisition_gap_receipt_board_rows", "0") == "10"
        and csv_value(priority_lsms_acquisition_gap_summary, "remaining_financial_country_gap", "missing") == "5"
        and csv_value(priority_lsms_acquisition_gap_summary, "remaining_double_failure_wave_gap", "missing") == "9"
        and csv_value(priority_lsms_acquisition_gap_summary, "acquisition_gap_missing_package_rows", "0") == "10"
        and csv_value(priority_lsms_acquisition_gap_summary, "modeling_gate_status", "missing") == "blocked"
        else "acquisition_gap_receipt_board_needs_review",
        f"rows={csv_value(priority_lsms_acquisition_gap_summary, 'acquisition_gap_receipt_board_rows', '0')}; countries={csv_value(priority_lsms_acquisition_gap_summary, 'acquisition_gap_receipt_country_rows', '0')}; current_promoted={csv_value(priority_lsms_acquisition_gap_summary, 'current_promoted_analysis_ready_rows', '0')}; current_financial_countries={csv_value(priority_lsms_acquisition_gap_summary, 'current_financial_protection_ready_countries', '0')}; current_double_failure_waves={csv_value(priority_lsms_acquisition_gap_summary, 'current_double_failure_ready_country_waves', '0')}; remaining_financial_gap={csv_value(priority_lsms_acquisition_gap_summary, 'remaining_financial_country_gap', 'missing')}; remaining_double_failure_gap={csv_value(priority_lsms_acquisition_gap_summary, 'remaining_double_failure_wave_gap', 'missing')}; missing_expected_files={csv_value(priority_lsms_acquisition_gap_summary, 'acquisition_gap_missing_expected_file_rows', '0')}; missing_core_files={csv_value(priority_lsms_acquisition_gap_summary, 'acquisition_gap_missing_core_file_rows', '0')}; blocked_requirements={csv_value(priority_lsms_acquisition_gap_summary, 'acquisition_gap_blocked_requirement_rows', '0')}; target_files={csv_value(priority_lsms_acquisition_gap_summary, 'acquisition_gap_target_file_rows', '0')}; incoming_files={csv_value(priority_lsms_acquisition_gap_summary, 'acquisition_gap_incoming_file_rows', '0')}; first_canary={csv_value(priority_lsms_acquisition_gap_summary, 'acquisition_gap_first_canary_idno', '')}; modeling_gate={csv_value(priority_lsms_acquisition_gap_summary, 'modeling_gate_status', 'missing')}",
        [RESULT_DIR / "priority_lsms_isa_acquisition_gap_receipt_board.csv", RESULT_DIR / "priority_lsms_isa_acquisition_gap_receipt_summary.csv", REPORT_DIR / "priority_lsms_isa_acquisition_gap_receipt_board.md"],
        "Acquisition gap receipt board reconciles the 10 remaining package downloads, local receipt status, threshold gap, and row-specific post-download validation commands without opening data writes or modeling.",
    )
    add_bundle(
        rows,
        "priority_bundle",
        "priority_lsms_isa_external_local_raw_candidate_audit",
        "external_local_candidates_found_provenance_not_accepted"
        if csv_value(priority_lsms_external_candidate_summary, "external_local_raw_candidate_root_exists", "0") == "1"
        and csv_value(priority_lsms_external_candidate_summary, "external_local_raw_candidate_locked_target_with_matches_rows", "0") != "0"
        and csv_value(priority_lsms_external_candidate_summary, "external_local_raw_candidate_provenance_accepted_rows", "1") == "0"
        and csv_value(priority_lsms_external_candidate_summary, "modeling_gate_status", "missing") == "blocked"
        else "external_local_candidate_audit_needs_review",
        f"queue_rows={csv_value(priority_lsms_external_candidate_summary, 'external_local_raw_candidate_queue_rows', '0')}; root_exists={csv_value(priority_lsms_external_candidate_summary, 'external_local_raw_candidate_root_exists', '0')}; folder_exists={csv_value(priority_lsms_external_candidate_summary, 'external_local_raw_candidate_folder_exists_rows', '0')}; expected_matches={csv_value(priority_lsms_external_candidate_summary, 'external_local_raw_candidate_expected_match_rows', '0')}; core_matches={csv_value(priority_lsms_external_candidate_summary, 'external_local_raw_candidate_core_match_rows', '0')}; locked_targets={csv_value(priority_lsms_external_candidate_summary, 'external_local_raw_candidate_locked_target_rows', '0')}; locked_with_matches={csv_value(priority_lsms_external_candidate_summary, 'external_local_raw_candidate_locked_target_with_matches_rows', '0')}; locked_core_complete={csv_value(priority_lsms_external_candidate_summary, 'external_local_raw_candidate_locked_core_complete_rows', '0')}; backup_with_matches={csv_value(priority_lsms_external_candidate_summary, 'external_local_raw_candidate_backup_with_matches_rows', '0')}; provenance_accepted={csv_value(priority_lsms_external_candidate_summary, 'external_local_raw_candidate_provenance_accepted_rows', '0')}; modeling_gate={csv_value(priority_lsms_external_candidate_summary, 'modeling_gate_status', 'missing')}",
        [RESULT_DIR / "priority_lsms_isa_external_local_raw_candidate_audit.csv", RESULT_DIR / "priority_lsms_isa_external_local_raw_candidate_file_match.csv", RESULT_DIR / "priority_lsms_isa_external_local_raw_candidate_summary.csv", REPORT_DIR / "priority_lsms_isa_external_local_raw_candidate_audit.md"],
        "External local raw candidate audit finds cross-project folders whose filenames match expected LSMS/ISA files, but keeps them as acquisition leads until official provenance and receipt validation pass.",
    )
    add_bundle(
        rows,
        "priority_bundle",
        "priority_lsms_isa_external_local_raw_intake_decision",
        "copy_review_queue_ready_provenance_not_accepted"
        if csv_value(priority_lsms_external_intake_summary, "external_local_raw_intake_copy_review_ready_rows", "0") != "0"
        and csv_value(priority_lsms_external_intake_summary, "external_local_raw_intake_provenance_accepted_rows", "1") == "0"
        and csv_value(priority_lsms_external_intake_summary, "external_local_raw_intake_immediate_copy_rows", "1") == "0"
        and csv_value(priority_lsms_external_intake_summary, "modeling_gate_status", "missing") == "blocked"
        else "external_local_intake_needs_review",
        f"review_rows={csv_value(priority_lsms_external_intake_summary, 'external_local_raw_intake_review_rows', '0')}; selected_review={csv_value(priority_lsms_external_intake_summary, 'external_local_raw_intake_selected_review_rows', '0')}; copy_review_ready={csv_value(priority_lsms_external_intake_summary, 'external_local_raw_intake_copy_review_ready_rows', '0')}; selected_partial={csv_value(priority_lsms_external_intake_summary, 'external_local_raw_intake_selected_partial_review_rows', '0')}; backup_review={csv_value(priority_lsms_external_intake_summary, 'external_local_raw_intake_backup_review_rows', '0')}; documents={csv_value(priority_lsms_external_intake_summary, 'external_local_raw_intake_document_manifest_rows', '0')}; provenance_accepted={csv_value(priority_lsms_external_intake_summary, 'external_local_raw_intake_provenance_accepted_rows', '0')}; immediate_copy={csv_value(priority_lsms_external_intake_summary, 'external_local_raw_intake_immediate_copy_rows', '0')}; modeling_gate={csv_value(priority_lsms_external_intake_summary, 'modeling_gate_status', 'missing')}",
        [RESULT_DIR / "priority_lsms_isa_external_local_raw_intake_decision.csv", RESULT_DIR / "priority_lsms_isa_external_local_raw_document_manifest.csv", RESULT_DIR / "priority_lsms_isa_external_local_raw_intake_summary.csv", REPORT_DIR / "priority_lsms_isa_external_local_raw_intake_decision.md"],
        "External local raw intake decision turns candidate folders into an ordered provenance-review and copy-review queue without accepting provenance or copying raw files.",
    )
    add_bundle(
        rows,
        "priority_bundle",
        "priority_lsms_isa_external_local_raw_staging",
        "raw_packages_staged_for_receipt_validation_provenance_not_accepted"
        if csv_value(priority_lsms_external_staging_summary, "external_local_raw_staging_executed_dataset_rows", "0") != "0"
        and csv_value(priority_lsms_external_staging_summary, "external_local_raw_staging_provenance_accepted_rows", "1") == "0"
        and csv_value(priority_lsms_external_staging_summary, "modeling_gate_status", "missing") == "blocked"
        else "external_local_raw_staging_plan_only_or_needs_review",
        f"mode={csv_value(priority_lsms_external_staging_summary, 'external_local_raw_staging_mode', 'missing')}; plan_rows={csv_value(priority_lsms_external_staging_summary, 'external_local_raw_staging_plan_rows', '0')}; file_rows={csv_value(priority_lsms_external_staging_summary, 'external_local_raw_staging_file_manifest_rows', '0')}; executed_datasets={csv_value(priority_lsms_external_staging_summary, 'external_local_raw_staging_executed_dataset_rows', '0')}; copied_files={csv_value(priority_lsms_external_staging_summary, 'external_local_raw_staging_copied_file_rows', '0')}; blocked_files={csv_value(priority_lsms_external_staging_summary, 'external_local_raw_staging_blocked_file_rows', '0')}; provenance_accepted={csv_value(priority_lsms_external_staging_summary, 'external_local_raw_staging_provenance_accepted_rows', '0')}; data_write={csv_value(priority_lsms_external_staging_summary, 'data_write_gate_status', 'missing')}; modeling_gate={csv_value(priority_lsms_external_staging_summary, 'modeling_gate_status', 'missing')}",
        [TEMP_DIR / "priority_lsms_isa_external_local_raw_staging_plan.csv", TEMP_DIR / "priority_lsms_isa_external_local_raw_staging_file_manifest.csv", RESULT_DIR / "priority_lsms_isa_external_local_raw_staging_summary.csv", REPORT_DIR / "priority_lsms_isa_external_local_raw_staging.md"],
        "External local raw staging copied selected review-ready folders into temp/raw_downloads for receipt validation, while keeping provenance acceptance, data writes, and modeling blocked.",
    )
    add_bundle(
        rows,
        "priority_bundle",
...
def build_summary(bundle: list[dict[str, str]], manifest: list[dict[str, str]]) -> list[dict[str, str]]:
    ...
    rows = [
        ...
        {"metric": "mwi2004_sdg382_spl_bridge_source_parameters_revalidated", "value": csv_value(mwi2004_sdg382_spl_bridge_summary, "source_parameters_revalidated", "0"), "interpretation": "Whether Malawi 2004 PPP/CPI source values were revalidated against the official World Bank API."},
        {"metric": "mwi2004_sdg382_spl_bridge_base_period_accepted", "value": csv_value(mwi2004_sdg382_spl_bridge_summary, "annual_cpi_bridge_base_period_accepted", "0"), "interpretation": "Whether annual CPI is accepted as the bridge to the survey real-currency base; should remain zero."},
        {"metric": "mwi2004_sdg382_spl_bridge_candidate_spl_raw", "value": csv_value(mwi2004_sdg382_spl_bridge_summary, "candidate_spl_daily_raw_2004_mwk", "missing"), "interpretation": "Recomputed candidate local-currency SPL; diagnostic only until the base-period bridge is accepted."},
        {"metric": "mwi2004_sdg382_spl_bridge_registry_status", "value": csv_value(mwi2004_sdg382_spl_bridge_summary, "registry_sdg382_status", "missing"), "interpretation": "Precise Malawi 2004 registry blocker after PPP/CPI revalidation."},
        ...
        {"metric": "priority_lsms_isa_receipt_handoff_rows", "value": csv_value(priority_lsms_receipt_handoff_summary, "post_download_receipt_handoff_rows", "0"), "interpretation": "Post-download receipt handoff rows for the locked download-required waves."},
        ...
        {"metric": "priority_lsms_isa_acquisition_gap_board_rows", "value": csv_value(priority_lsms_acquisition_gap_summary, "acquisition_gap_receipt_board_rows", "0"), "interpretation": "Rows in the unified acquisition gap and receipt board."},
        {"metric": "priority_lsms_isa_acquisition_gap_remaining_financial_country_gap", "value": csv_value(priority_lsms_acquisition_gap_summary, "remaining_financial_country_gap", "missing"), "interpretation": "Financial-protection-ready countries still needed before modeling can resume."},
        {"metric": "priority_lsms_isa_acquisition_gap_remaining_double_failure_wave_gap", "value": csv_value(priority_lsms_acquisition_gap_summary, "remaining_double_failure_wave_gap", "missing"), "interpretation": "Double-failure-ready country-waves still needed before modeling can resume."},
        {"metric": "priority_lsms_isa_acquisition_gap_missing_package_rows", "value": csv_value(priority_lsms_acquisition_gap_summary, "acquisition_gap_missing_package_rows", "0"), "interpretation": "Download-required rows still lacking a local package or incoming file."},
        {"metric": "priority_lsms_isa_acquisition_gap_first_canary", "value": csv_value(priority_lsms_acquisition_gap_summary, "acquisition_gap_first_canary_idno", ""), "interpretation": "First package to download and validate before scaling the remaining batch."},
        {"metric": "priority_lsms_isa_external_candidate_locked_target_with_matches", "value": csv_value(priority_lsms_external_candidate_summary, "external_local_raw_candidate_locked_target_with_matches_rows", "0"), "interpretation": "Selected rows with external local expected-file matches."},
        {"metric": "priority_lsms_isa_external_candidate_locked_core_complete", "value": csv_value(priority_lsms_external_candidate_summary, "external_local_raw_candidate_locked_core_complete_rows", "0"), "interpretation": "Selected rows whose requirement-linked core filenames are complete in the external local candidate folder."},
        {"metric": "priority_lsms_isa_external_candidate_backup_with_matches", "value": csv_value(priority_lsms_external_candidate_summary, "external_local_raw_candidate_backup_with_matches_rows", "0"), "interpretation": "Backup rows with external local expected-file matches."},
        {"metric": "priority_lsms_isa_external_candidate_provenance_accepted", "value": csv_value(priority_lsms_external_candidate_summary, "external_local_raw_candidate_provenance_accepted_rows", "0"), "interpretation": "External local candidates accepted as official receipt; should remain zero until provenance review passes."},
        {"metric": "priority_lsms_isa_external_intake_copy_review_ready", "value": csv_value(priority_lsms_external_intake_summary, "external_local_raw_intake_copy_review_ready_rows", "0"), "interpretation": "Selected rows ready for official-provenance review before any raw copy."},
        {"metric": "priority_lsms_isa_external_intake_selected_partial_review", "value": csv_value(priority_lsms_external_intake_summary, "external_local_raw_intake_selected_partial_review_rows", "0"), "interpretation": "Selected rows with partial external local matches needing missing-file or provenance triage."},
        {"metric": "priority_lsms_isa_external_intake_backup_review", "value": csv_value(priority_lsms_external_intake_summary, "external_local_raw_intake_backup_review_rows", "0"), "interpretation": "Backup rows with external local matches held behind the selected batch."},
        {"metric": "priority_lsms_isa_external_intake_provenance_accepted", "value": csv_value(priority_lsms_external_intake_summary, "external_local_raw_intake_provenance_accepted_rows", "0"), "interpretation": "External local raw folders accepted as official receipt; should remain zero until review passes."},
        {"metric": "priority_lsms_isa_external_staging_executed_dataset_rows", "value": csv_value(priority_lsms_external_staging_summary, "external_local_raw_staging_executed_dataset_rows", "0"), "interpretation": "External local raw-folder candidates copied into temp/raw_downloads for receipt validation."},
        {"metric": "priority_lsms_isa_external_staging_copied_file_rows", "value": csv_value(priority_lsms_external_staging_summary, "external_local_raw_staging_copied_file_rows", "0"), "interpretation": "Raw/documentation files staged from external local folders."},
        {"metric": "priority_lsms_isa_external_staging_provenance_accepted", "value": csv_value(priority_lsms_external_staging_summary, "external_local_raw_staging_provenance_accepted_rows", "0"), "interpretation": "Staged external local packages accepted as official provenance; should remain zero until review passes."},
